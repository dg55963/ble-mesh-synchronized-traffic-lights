...
static esp_ble_mesh_model_op_t vnd_op[] = {
    ...
    ESP_BLE_MESH_MODEL_OP(ESP_BLE_MESH_VND_MODEL_OP_SYNC_REQUEST, 0),    ESP_BLE_MESH_MODEL_OP(ESP_BLE_MESH_VND_MODEL_OP_SYNC_RESPONSE, 0),
    ESP_BLE_MESH_MODEL_OP(ESP_BLE_MESH_VND_MODEL_OP_SCENE_COMMAND, 0),   ESP_BLE_MESH_MODEL_OP_END,
};
