...
#define ESP_BLE_MESH_VND_MODEL_OP_SYNC_REQUEST ESP_BLE_MESH_MODEL_OP_3(0x06, CID_ESP)
#define ESP_BLE_MESH_VND_MODEL_OP_SYNC_RESPONSE ESP_BLE_MESH_MODEL_OP_3(0x07, CID_ESP)
#define ESP_BLE_MESH_VND_MODEL_OP_SCENE_COMMAND ESP_BLE_MESH_MODEL_OP_3(0x08, CID_ESP)
